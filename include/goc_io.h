...
/**
 * goc_io_write_ch() — Initiate an async stream write; return result channel.
 *
...
/**
 * goc_io_udp_send_ch() — Initiate an async UDP send; return result channel.
 *
...
/**
 * goc_io_fs_open_ch() — Initiate an async file open; return result channel.
 *
 * path  : file path.
