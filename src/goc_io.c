...
{
    goc_chan*  ch = goc_io_fs_stat_ch(path);
    goc_val_t* v  = goc_take(ch);
    return (goc_io_fs_stat_t*)v->val;
}
                                         ...
                                         const struct addrinfo* hints)
{
    ...
    goc_val_t* v  = goc_take(ch);
    return (goc_io_getaddrinfo_t*)v->val;
}
...
{
    goc_chan*  ch = goc_io_getnameinfo_ch(addr, flags);
    goc_val_t* v  = goc_take(ch);
    return (goc_io_getnameinfo_t*)v->val;
}
...
/* -------------------------------------------------------------------------
 * goc_io_write2 / goc_io_write2_ch  (IPC streams)
 * ---------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------
 * goc_io_shutdown_stream / goc_io_shutdown_stream_ch
 * ---------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------
 * goc_io_tcp_connect / goc_io_tcp_connect_ch
 * ---------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------
 * goc_io_pipe_connect / goc_io_pipe_connect_ch
 * ---------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------
 * goc_io_udp_send / goc_io_udp_send_ch
 * ---------------------------------------------------------------------- */
